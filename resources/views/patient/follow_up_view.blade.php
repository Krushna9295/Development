...
<div class="wrapper">
    ...
    <div class="content-wrapper">
        ...
        <div class="container-fluid">
            <!-- SELECT2 EXAMPLE -->
            @if(!isset($patient->pk_id) && $action == "Follow Up")
                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        <div class="col-md-2">
                            <div class="form-group">
                                <label>HRCT</label>
                                <input type="text" class="form-control" name="	followup_hrct" id="	followup_hrct" placeholder="HRCT" style="width: 100%;" value="">
                    ...
                    <div class="row" id="dynamic_field">
                        <div class="col-md-3">
                            <lable class="">Hospital Detais : </lable>
                        </div>
                        <div class="col-md-2">
                    ...
                    <div class="row" id="dynamic_field">
                        ...
                        <div class="col-md-2">
                            <input type="text" class="form-control" name="followup_remark" id="followup_remark" placeholder="Contact No." value="">   
                        </div>
                    </div>
